...
app.get('/wcnbsimple.js', function(req, res){
  res.sendFile(path.join(__dirname + '/node_modules/web-component-container-simple/dist/wccontainersimple.js'));
});
...
app.get('/css/app.css', function(req,res){
  res.sendFile(path.join(__dirname + '/wcContainerColumns.css'))
});

app.get('/css/wcContainer.css', function(req,res){
  res.sendFile(path.join(__dirname + '/node_modules/web-component-container-simple/wcContainer.css'))
});
...
app.get('/container-columns.html', function(req, res){
  res.sendFile(path.join(__dirname + '/container-columns.html'));
});
...
app.get('/assets/images/image-01.jpg', function(req, res){
  res.sendFile(path.join(__dirname + '/assets/images/toolsYouKnowIllustration-01.jpg'));
});
